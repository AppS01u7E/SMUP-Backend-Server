...
import com.appsolute.soomapi.domain.account.data.request.StudentSignupRequest;
import com.appsolute.soomapi.domain.account.data.request.TeacherSignupRequest;
import com.appsolute.soomapi.domain.account.data.response.StudentSignupResponse;
import com.appsolute.soomapi.domain.account.data.response.TeacherSignupResponse;
