...
class FcmServiceImpl(
    ...
    override fun sendMessageTo(targetId: String, title: String, body: String): List<String> {
    ...
    override fun sendMessageRangeTo(receiverIds: List<String>, title: String, body: String) {
